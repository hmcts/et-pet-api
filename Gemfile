...
gem 'et_exporter', git: 'https://github.com/hmcts/et_exporter_gem.git', tag: 'v3.0.5'

gem "activerecord-nulldb-adapter", "~> 1.0", group: :test

gem "et_ccd_export", git: 'https://github.com/hmcts/et-pet-ccd-export.git', branch: 'rst-8482'
...
group :test do
  gem 'et_fake_ccd', git: 'https://github.com/hmcts/et-fake-ccd.git', tag: 'v3.2.4'
end
