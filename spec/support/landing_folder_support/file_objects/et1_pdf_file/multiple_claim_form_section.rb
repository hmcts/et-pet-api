            ...
            if claimants.length > 1
              expected_values = (1..6).reduce({}) do |acc, claimant_number|
                ...
                acc[:"additional_claimant_#{claimant_number}"] = {
                  ...
                  dob_day: formatted_date(claimant&.date_of_birth, optional: claimant.nil?)&.split('/')&.at(0) || '',
                  dob_month: formatted_date(claimant&.date_of_birth, optional: claimant.nil?)&.split('/')&.at(1) || '',
                  dob_year: formatted_date(claimant&.date_of_birth, optional: claimant.nil?)&.split('/')&.at(2) || '',
