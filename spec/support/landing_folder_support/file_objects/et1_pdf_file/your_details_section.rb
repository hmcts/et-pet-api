        ...
        class YourDetailsSection < EtApi::Test::FileObjects::Et1PdfFileSection::Base
          def has_contents_for?(claimant:)
            expected_values = {
                ...
                building: claimant.dig(:address_attributes, :building),
                street: claimant.dig(:address_attributes, :street),
                locality: claimant.dig(:address_attributes, :locality),
                county: claimant.dig(:address_attributes, :county),
                post_code: post_code_for(claimant.dig(:address_attributes, :post_code)),
