...
RspecApiDocumentation.configure do |config|
  ...
  config.format = [:open_api, :markdown]
  #
  ...
  config.api_name = "Employment Tribunal API V2"
  #
  # # Change the description of the API on index pages
  config.api_explanation = "Central API for employment tribunal system"
  #
...
RSpec.configure do |c|
  #c.include ::EtApi::Test::ApiDocumentation, type: :request
end
