...
# @TODO This spec is pretty much a clone of create_claim_spec - Refactoring is required to use factories then DRY some of this up
RSpec.describe 'CreateClaim Request with CSV upload from ET1', type: :request do
