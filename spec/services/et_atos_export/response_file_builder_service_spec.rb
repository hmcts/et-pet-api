  ...
  RSpec.describe ResponseFileBuilderService do
    ...
    describe '#call' do
      ...
      it 'has the correct default builder for the rtf file' do
        ...
        class_spy('::EtAtosExport::ResponseFileBuilder::BuildResponseTextFile').as_stubbed_const
        expected_class = class_spy('::EtAtosExport::ResponseFileBuilder::BuildResponseRtfFile').as_stubbed_const
