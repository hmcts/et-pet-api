...
RSpec.describe BuildClaimPdfFileService do
  ...
  describe '#call' do
    ...
    shared_examples 'for any claim variation' do
      ...
      it 'stores an ET1 pdf file from the english v6 template with the correct contents' do
        # Act
        builder.call(claim)
        claim.save!
        ...
        Dir.mktmpdir do |dir|
          ...
          File.open full_path do |file|
            et1_file = EtApi::Test::FileObjects::Et1PdfFile.new(file, template: 'et1-v6-en', lookup_root: 'claim_pdf_fields')
    ...
    context 'when using an alternative pdf template' do
      ...
      it 'stores an ET1 pdf file from the welsh v4 template with the correct contents' do
        # Act
        builder.call(claim, template_reference: 'et1-v6-cy')
        claim.save!
        ...
        Dir.mktmpdir do |dir|
          ...
          uploaded_file.download_blob_to(full_path)
          File.open full_path do |file|
            et1_file = EtApi::Test::FileObjects::Et1PdfFile.new(file, template: 'et1-v6-cy', lookup_root: 'claim_pdf_fields')
