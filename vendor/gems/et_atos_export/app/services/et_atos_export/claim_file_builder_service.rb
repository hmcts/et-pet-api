...
module EtAtosExport
  ...
  class ClaimFileBuilderService
    def initialize(claim,
      claim_text_file_builder: ::EtAtosExport::ClaimFileBuilder::BuildClaimTextFile,
      claimants_text_file_builder: ::EtAtosExport::ClaimFileBuilder::BuildClaimantsTextFile)
