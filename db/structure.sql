...
CREATE TABLE public.admin_permissions_roles (
...
CREATE TABLE public.admin_roles_users (
    role_id bigint NOT NULL,
...
CREATE INDEX index_admin_roles_users_on_role_id_and_user_id ON public.admin_roles_users USING btree (role_id, user_id);
...
CREATE INDEX index_admin_roles_users_on_user_id_and_role_id ON public.admin_roles_users USING btree (user_id, role_id);
