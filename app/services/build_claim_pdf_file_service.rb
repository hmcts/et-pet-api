class BuildClaimPdfFileService
  ...
  def self.call(source, template_reference: 'et1-v5-en', time_zone: 'London', **kwargs)
  ...
  def render_to_files
    ...
    path_specs = [{ et1.output_file.path => ['1-13'] }]
    path_specs << { et1a.output_file.path => ['13-15'] } if et1a

    [
      Tempfile.new.tap { |file| builder.cat(*path_specs, { et1.output_file.path => ['14-14'] }, file.path) },
